                        ...
                        do {
                            ...
                            $choix1_1 = Read-Host "Enter your choice"
                                    ...
                                    switch ($choix1_1) {
                                        ...
                                        1 {
                                            Get-ADUser -Identity $nomUser1 -Properties * | Select-Object EmailAddress, wWWHomePage, SamAcountName, PasswordLastSet, PasswordExpired, Department, Description, DisplayName, DistinguishedName, whenCreated, Enabled
                                            pause | Clear-Host
                                        }
                                        2 {
